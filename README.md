...
Advanced 3D animated portfolio built with **Next.js 15, TypeScript, Firebase**, and an admin APK download system.
...
Camera readiness checks and face-sync application built with **Vite, React and shadcn/ui**.
...
Cross-platform **Flutter application** for spinning and earning rewards natively.
...
Responsive weather application fetching real-time data from REST APIs dynamically.
...
<a href="https://weather-app-five-dun-93.vercel.app">
🔴 Live Demo
</a>
...
## 🛍️ Buynora E-Commerce

Premium AI-powered E-Commerce marketplace with advanced recommendations and secure checkout.

**Tech:** `React` `MySQL`

<br>

<a href="https://github.com/ommaurya2580-beep/Buynora">
⭐ GitHub Repository
</a>
...
AI-powered counselling platform for predicting colleges and analyzing cutoffs for students.

**Tech:** `Next.js` `Firebase`

<br>

<a href="https://github.com/ommaurya2580-beep/AKTU-Counselling-Helper">
⭐ GitHub Repository
</a>
...
IoT-based Smart Farming Solution using sensors, Arduino and ESP32 cloud dashboard monitoring.

**Tech:** `Arduino` `ESP32`

<br>

<a href="https://github.com/ommaurya2580-beep/AGRI-MOIST-SOIL-DASHBOARD">
⭐ GitHub Repository
</a>
...
Modern Resume Builder powered by AI and OpenAI API for instant generation.

**Tech:** `Next.js` `OpenAI API`

<br>

<a href="https://github.com/ommaurya2580-beep/AI-Resume-Builder">
⭐ GitHub Repository
</a>
...
**November 2025 · Oasis Infobyte**

Developed responsive frontend interfaces using modern web technologies, reusable UI components and improved UX.
